...
export function AppShell({
  ...
  return (
    <div className="min-h-screen bg-[#f5f4f7] text-[#111827] dark:bg-[#0b1220]">
      <div className="relative min-h-screen bg-[radial-gradient(circle_at_50%_0%,rgba(255,255,255,0.98),rgba(244,244,247,0.96)_48%,#eceff4_100%)] dark:bg-none">
        <div className="absolute inset-x-0 bottom-0 h-48 bg-[radial-gradient(circle_at_50%_100%,rgba(202,211,223,0.38),rgba(245,244,247,0)_68%)] dark:hidden" />
        <div className="mx-auto flex min-h-screen max-w-[1260px] flex-col px-3 py-4 sm:px-5 sm:py-6">
          <div className="relative flex min-h-[calc(100vh-2rem)] flex-col overflow-hidden rounded-[34px] border border-[#e8ebf0] bg-[linear-gradient(180deg,rgba(251,251,253,0.96)_0%,rgba(245,247,251,0.98)_100%)] shadow-[0_38px_100px_-72px_rgba(15,23,42,0.26)] dark:border-[rgba(148,163,184,0.12)] dark:bg-[rgba(11,18,32,0.92)] dark:shadow-[0_38px_100px_-72px_rgba(2,8,23,0.8)] lg:grid lg:grid-cols-[198px_minmax(0,1fr)]">
            <aside className="hidden border-r border-[#eceef3] bg-[linear-gradient(180deg,#efeff3_0%,#f3f4f8_100%)] px-4 pb-5 pt-5 dark:border-[rgba(148,163,184,0.1)] dark:bg-[rgba(15,23,42,0.6)] lg:flex lg:flex-col">
              ...
              <div className="rounded-[14px] bg-[#f3f5f9] p-2 dark:bg-[rgba(30,41,59,0.5)]">
                    ...
                    return (
                      <Link
                        ...
                        className={cn(
                          ...
                          active
                            ? "bg-[#dce8fb] text-[#4f77b8] dark:bg-[rgba(79,119,184,0.18)] dark:text-[#7aaeff]"
                            : "text-[#7c8494] hover:bg-white hover:text-[#111827] dark:hover:bg-[rgba(30,41,59,0.7)]",
                        )}
                      >
              ...
              <div className="mt-7 border-t border-[#e3e5eb] px-2 pt-5 dark:border-[rgba(148,163,184,0.1)]">
              ...
              <div className="mt-auto border-t border-[#e3e5eb] px-2 pt-4 dark:border-[rgba(148,163,184,0.1)]">
                <Link
                  href="/settings"
                  className={cn(
                    "flex items-center gap-2.5 rounded-[10px] px-2 py-2 text-[11px] font-medium transition",
                    pathname === "/settings"
                      ? "bg-white/90 text-[#4f77b8] dark:bg-[rgba(79,119,184,0.18)] dark:text-[#7aaeff]"
                      : "text-[#7c8494] hover:bg-white hover:text-[#111827] dark:hover:bg-[rgba(30,41,59,0.7)]",
                  )}
                >
            ...
            <div className="min-w-0">
              <header className="sticky top-0 z-30 hidden border-b border-[#eceef3] bg-white/76 px-4 py-4 backdrop-blur-xl dark:border-[rgba(148,163,184,0.1)] dark:bg-[rgba(11,18,32,0.88)] sm:px-5 lg:block lg:px-7">
